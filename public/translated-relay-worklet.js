class TranslatedRelayProcessor extends AudioWorkletProcessor {
  constructor() {
    super();
    this.pending = [];
    this.phase = 0;
  ...
  process(inputs) {
    ...
    // 50 ms at 24 kHz: short enough to keep fanout latency negligible.
    while (this.pending.length >= 1200) {
...
registerProcessor("translated-relay", TranslatedRelayProcessor);
